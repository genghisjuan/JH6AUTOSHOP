...
const items: Item[] = [
  { title: "R32 GT-R Front Emblem (STL)", price: "$12.00", image: "/scans/r32_emblem.png" },
  { title: "S15 Shift Knob (OBJ)",        price: "$9.00",  image: "/scans/s15_shift_knob.png" },
  { title: "E36 Touring Badge (STL)",     price: "$7.00",  image: "/scans/e36_touring_badge.png" },
  { title: "JDM Plate Bracket (GLB)",     price: "$10.00", image: "/scans/jdm_plate_bracket.png" },
];
