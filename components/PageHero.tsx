  ...
  return (
    <section className="relative isolate">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-[calc(72px+env(safe-area-inset-top))] sm:px-6 sm:pb-24 sm:pt-[calc(96px+env(safe-area-inset-top))]">
        <h1 className="max-w-4xl text-4xl font-extrabold leading-[1.05] tracking-tight drop-shadow sm:text-5xl md:text-6xl">
          {title}
        </h1>
        {subtitle && (
          <p className="mt-5 max-w-3xl text-sm text-white/75 sm:text-base">
            {subtitle}
          </p>
        )}
      </div>
